        ...
        <section className='relative max-w-6xl mx-auto px-6 py-24 flex flex-col items-center gap-12 text-center overflow-hidden'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 w-full sm:w-auto relative z-10'>
                <div className='relative group'>
                    ...
                    <Button
                        size='lg'
                        className='relative w-full sm:w-auto h-16 px-10 bg-primary hover:bg-primary/90 text-black font-black uppercase italic text-xl rounded-xl border-t border-white/40 shadow-2xl transition-transform active:scale-95'
                        asChild
                    >
                        <Link
                            href={sigmodLink}
            ...
            <div className='flex flex-col items-center gap-4 pt-4'>
                ...
                <div className='flex gap-6 opacity-60 hover:opacity-100 transition-opacity'>
                    <Link
                        ...
                        className='text-xs font-bold text-neutral-300 hover:text-primary transition-colors border-b border-white/10 pb-1'
                    >
                        Tampermonkey
                    </Link>
